...
/**
 * Created by headwind on 2018/3/19.
 */
...
public class WifiAdmin {
    ...
    public StringBuilder lookUpScan() {
        ...
        LogManager.d("MainActivity", "lookUpScan: "+String.valueOf(mWifiList.size()));
        for (int i = 0; i < mWifiList.size(); i++) {
            stringBuilder.append("WIFI_" + new Integer(i + 1).toString() + ":");
            ScanResult scanResult = mWifiList.get(i);
            stringBuilder.append(" SSID : "+scanResult.SSID.toString());
            stringBuilder.append(" BSSID : "+scanResult.BSSID.toString());
